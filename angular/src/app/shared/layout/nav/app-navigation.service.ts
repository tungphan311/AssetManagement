    ...
    getMenu(): AppMenu {
        return new AppMenu('MainMenu', 'MainMenu', [
            ...
            new AppMenuItem('Administration', '', 'flaticon-interface-8', '', [
                ...
                new AppMenuItem('Customers', 'Pages.Administration.Customer', 'flaticon-menu-1', '/app/gwebsite/customer'),
                new AppMenuItem('Tài sản thuê', 'Pages.Administration.DemoModel', 'flaticon-menu-1', '/app/gwebsite/customer0')
            ]),
