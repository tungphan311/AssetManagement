...
export class VehicleComponent extends AppComponentBase implements AfterViewInit, OnInit {
    ...
    @ViewChild('createOrEditModal') createOrEditModal: CreateOrEditVehicleModalComponent;
