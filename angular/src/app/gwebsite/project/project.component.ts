...
export class ProjectComponent extends AppComponentBase implements AfterViewInit, OnInit {
    ...
    reloadList(projectName, event?: LazyLoadEvent) {
        this._projectService.getProjectsByFilter(projectName, this.primengTableHelper.getSorting(this.dataTable),
    ...
    init(): void {
        ...
        this._activatedRoute.params.subscribe((params: Params) => {
            ...
            this.reloadList(this.projectName, null);
        });
    }
