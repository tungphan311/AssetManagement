...
export class BidComponent extends AppComponentBase implements AfterViewInit, OnInit {
    ...
    reloadList(bidCode, event?: LazyLoadEvent) {
        this._bidService.getBidsByFilter(bidCode, this.primengTableHelper.getSorting(this.dataTable),
    ...
    init(): void {
        ...
        this._activatedRoute.params.subscribe((params: Params) => {
            this.bidCode = params['code'] || '';
            this.reloadList(this.bidCode, null);
        });
    }
