...
export class CreateDetailAssetRentModalComponent extends AppComponentBase {
    ...
    // tslint:disable-next-line:use-life-cycle-interface
    getAssetRent(assetRentId?: number | null | undefined): void {
        this._assetRentService
            .getAssetRenttForView(assetRentId)
            .subscribe(response => {
                this.nameAsset = response.nameAsset;
                this.rentBy = response.rentBy;
            });
    }

    show(detailAssetRentId?: number | null | undefined): void {
        this.saving = false;
        this.assetRentId = detailAssetRentId;
        this.getAssetRent(this.assetRentId);
    ...
    save(): void {
        this.detailassetrent.assetRentId = this.assetRentId;
        this.detailassetrent.nameAsset = this.nameAsset;
        this.detailassetrent.rentBy = this.rentBy;
