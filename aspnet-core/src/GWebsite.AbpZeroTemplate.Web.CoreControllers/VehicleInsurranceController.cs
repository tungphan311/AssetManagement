...
namespace GWebsite.AbpZeroTemplate.Application.Controllers
{
    ...
    public class VehicleInsurranceController : GWebsiteControllerBase
    {
        ...
        [HttpGet]
        public int GetVehicleInsurranceNumber(int insurrancenumber, string plateNumber)
        {
            return vehicleInsurranceAppService.GetVehicleInsurranceNumber(insurrancenumber, plateNumber);
        }
    }
}